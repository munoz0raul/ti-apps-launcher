...
RunCmd *demo_3d = new RunCmd(QStringLiteral("WAYLAND_USER=weston XDG_RUNTIME_DIR=/run/user/63 WAYLAND_DISPLAY=wayland-1 /usr/bin/SGX/demos/Wayland/OpenGLESSkinning"));
